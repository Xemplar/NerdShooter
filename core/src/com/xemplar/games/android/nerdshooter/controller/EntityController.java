...
public class EntityController implements Controller{
    ...
    private void checkCollisionWithBlocks(float delta) {
        ...
        for (Block block : collidable) {
            ...
            if (entity.getBounds().overlaps(block.getBounds()) && block.isCollidable()) {
        ...
        for (Block block : collidable) {
            ...
            if (entityRect.overlaps(block.getBounds()) && block.isCollidable()) {
    ...
    public static final void setWorld(World w){
        world = w;
    }
}
